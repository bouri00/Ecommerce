  ...
  <div class="wraper-inner">
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 form-vertical">
        <div class="formaccount formlogin"><form method="POST" action="{{ route('register') }}" id="loginForm">
                        {{ csrf_field() }}
          ...
          <label for="CreatePassword">Confirm Mot de passe : </label>
          <input type="password" name="password_confirmation" id="CreatePassword" class="">
<!--
